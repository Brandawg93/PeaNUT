  ...
  return (
    <Dropdown as={ButtonGroup} onSelect={handleSelect}>
      ...
      <Dropdown.Menu>
        ...
        <Dropdown.Item eventKey={1} active={refreshInterval === '1'}>
          1s
        </Dropdown.Item>
        <Dropdown.Item eventKey={3} active={refreshInterval === '3'}>
          3s
        </Dropdown.Item>
        <Dropdown.Item eventKey={5} active={refreshInterval === '5'}>
          5s
        </Dropdown.Item>
        <Dropdown.Item eventKey={10} active={refreshInterval === '10'}>
          10s
        </Dropdown.Item>
        <Dropdown.Item eventKey={30} active={refreshInterval === '30'}>
          30s
        </Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
